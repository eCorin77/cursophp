...
<html>
    ...
    <body>
        ...
        if ($nombre && filter_var($email, FILTER_VALIDATE_EMAIL) && (preg_match($pass_pattern, $password))) {
            ...
            $query = "SELECT * FROM clientes_hash WHERE nombre = '$nombre' OR correo = '$email'";
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                // Si todo está bien, hasheamos la contraseña antes de almacenarla
                $hashed_password = password_hash($password, PASSWORD_DEFAULT);

                // Insertamos los datos en la base de datos
                $insert_query = "INSERT INTO clientes_hash (nombre, correo, password) VALUES ('$nombre', '$email', '$hashed_password')";
